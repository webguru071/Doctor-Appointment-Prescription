...
{
    public partial class All_Appointment_print : Form
    {
        connection db = new connection();
        public All_Appointment_print()
        {
            InitializeComponent();
        ...
        private void All_Appointment_print_Load(object sender, EventArgs e)
        {
            header();
            string date = dateTimePicker1.Text;
            DateTime d = DateTime.ParseExact(date, "dd/MM/yyyy", CultureInfo.InvariantCulture);
            ...
            DateTime d2 = DateTime.ParseExact(date2, "dd/MM/yyyy", CultureInfo.InvariantCulture);
            string dd2 = d2.ToString("yyyy/MM/dd");
            // TODO: This line of code loads data into the 'DataSet57.appointment' table. You can move, or remove it, as needed.
            this.appointmentTableAdapter.Fill(this.DataSet57.appointment,dd,dd2);
