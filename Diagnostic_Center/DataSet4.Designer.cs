...
namespace Diagnostic_Center {
    ...
    public partial class DataSet4 : global::System.Data.DataSet {
        ...
        public partial class expenseDataTable : global::System.Data.TypedTableBase<expenseRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public expenseRow AddexpenseRow(string title, double amount, string date) {
...
namespace Diagnostic_Center.DataSet4TableAdapters {
    ...
    public partial class expenseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[expense] WHERE (([id] = @Original_id) AND ((@IsNull_amount = 1" +
                " AND [amount] IS NULL) OR ([amount] = @Original_amount)) AND ((@IsNull_date = 1 " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[expense] ([title], [amount], [date]) VALUES (@title, @amount, " +
                "@date)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[expense] SET [title] = @title, [amount] = @amount, [date] = @date WHERE (([id] = @Original_id) AND ((@IsNull_amount = 1 AND [amount] IS NULL) OR ([amount] = @Original_amount)) AND ((@IsNull_date = 1 AND [date] IS NULL) OR ([date] = @Original_date)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id,title, amount, date FROM dbo.expense where date between @x and @y";
        ...
        public virtual int Fill(DataSet4.expenseDataTable dataTable, string x, string y) {
        ...
        public virtual DataSet4.expenseDataTable GetData(string x, string y) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((x == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            ...
            DataSet4.expenseDataTable dataTable = new DataSet4.expenseDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet4.expenseDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, global::System.Nullable<double> Original_amount, string Original_date) {
        ...
        public virtual int Insert(string title, global::System.Nullable<double> amount, string date) {
            if ((title == null)) {
        ...
        public virtual int Update(string title, global::System.Nullable<double> amount, string date, int Original_id, global::System.Nullable<double> Original_amount, string Original_date) {
            if ((title == null)) {
                throw new global::System.ArgumentNullException("title");
            }
            else {
