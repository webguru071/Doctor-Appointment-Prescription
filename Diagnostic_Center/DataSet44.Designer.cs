...
namespace Diagnostic_Center.DataSet44TableAdapters {
    ...
    public partial class opdTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[opd] ([reg_no], [name], [contact], [gender], [age], [address], [date], [time], [gurdian], [word], [thana], [district], [consultant], [referance], [card_id]) VALUES (@reg_no, @name, @contact, @gender, @age, @address, @date, @time, @gurdian, @word, @thana, @district, @consultant, @referance, @card_id);
SELECT reg_no, name, contact, gender, age, address, date, time, gurdian, word, thana, district, consultant, referance, card_id FROM opd WHERE (reg_no = @reg_no)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[opd] SET [reg_no] = @reg_no, [name] = @name, [contact] = @contact, [gender] = @gender, [age] = @age, [address] = @address, [date] = @date, [time] = @time, [gurdian] = @gurdian, [word] = @word, [thana] = @thana, [district] = @district, [consultant] = @consultant, [referance] = @referance, [card_id] = @card_id WHERE (([reg_no] = @Original_reg_no) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_contact = 1 AND [contact] IS NULL) OR ([contact] = @Original_contact)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)) AND ((@IsNull_date = 1 AND [date] IS NULL) OR ([date] = @Original_date)) AND ((@IsNull_time = 1 AND [time] IS NULL) OR ([time] = @Original_time)) AND ((@IsNull_word = 1 AND [word] IS NULL) OR ([word] = @Original_word)) AND ((@IsNull_thana = 1 AND [thana] IS NULL) OR ([thana] = @Original_thana)) AND ((@IsNull_district = 1 AND [district] IS NULL) OR ([district] = @Original_district)) AND ((@IsNull_card_id = 1 AND [card_id] IS NULL) OR ([card_id] = @Original_card_id)));
SELECT reg_no, name, contact, gender, age, address, date, time, gurdian, word, thana, district, consultant, referance, card_id FROM opd WHERE (reg_no = @reg_no)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT reg_no, name, contact, gender, age, address, date, time, gurdian, word, th" +
                "ana, district, consultant, referance,card_id FROM dbo.opd where reg_no=@x";
        ...
        public virtual int Fill(DataSet44.opdDataTable dataTable, int x) {
        ...
        public virtual DataSet44.opdDataTable GetData(int x) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(x));
            DataSet44.opdDataTable dataTable = new DataSet44.opdDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet44.opdDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet44 dataSet) {
        ...
        public virtual int Insert(int reg_no, string name, string contact, string gender, string age, string address, string date, string time, string gurdian, string word, string thana, string district, string consultant, string referance, string card_id) {
