...
namespace Diagnostic_Center.DataSet32TableAdapters {
    ...
    public partial class employeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[employee] WHERE (([employee_id] = @Original_employee_id) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_birth_date = 1 AND [birth_date] IS NULL) OR ([birth_date] = @Original_birth_date)) AND ((@IsNull_post_code = 1 AND [post_code] IS NULL) OR ([post_code] = @Original_post_code)) AND ((@IsNull_city = 1 AND [city] IS NULL) OR ([city] = @Original_city)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_nid = 1 AND [nid] IS NULL) OR ([nid] = @Original_nid)) AND ((@IsNull_department = 1 AND [department] IS NULL) OR ([department] = @Original_department)) AND ([salary] = @Original_salary) AND ((@IsNull_additional = 1 AND [additional] IS NULL) OR ([additional] = @Original_additional)) AND ((@IsNull_joining_date = 1 AND [joining_date] IS NULL) OR ([joining_date] = @Original_joining_date)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[employee] ([employee_id], [name], [f_name], [m_name], [gender], [birth_date], [post_code], [thana], [zela], [city], [phone], [nid], [job_post], [department], [salary], [additional], [joining_date], [image]) VALUES (@employee_id, @name, @f_name, @m_name, @gender, @birth_date, @post_code, @thana, @zela, @city, @phone, @nid, @job_post, @department, @salary, @additional, @joining_date, @image);
SELECT employee_id, name, f_name, m_name, gender, birth_date, post_code, thana, zela, city, phone, nid, job_post, department, salary, additional, joining_date, image FROM employee WHERE (employee_id = @employee_id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[employee] SET [employee_id] = @employee_id, [name] = @name, [f_name" +
                ...
                " [image] = @image WHERE (([employee_id] = @Original_employee_id) AND ((@IsNull_g" +
                "ender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_" +
                "birth_date = 1 AND [birth_date] IS NULL) OR ([birth_date] = @Original_birth_date" +
                ")) AND ((@IsNull_post_code = 1 AND [post_code] IS NULL) OR ([post_code] = @Origi" +
                "nal_post_code)) AND ((@IsNull_city = 1 AND [city] IS NULL) OR ([city] = @Origina" +
                "l_city)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_ph" +
                "one)) AND ((@IsNull_nid = 1 AND [nid] IS NULL) OR ([nid] = @Original_nid)) AND (" +
                "(@IsNull_department = 1 AND [department] IS NULL) OR ([department] = @Original_d" +
                "epartment)) AND ([salary] = @Original_salary) AND ((@IsNull_additional = 1 AND [" +
                "additional] IS NULL) OR ([additional] = @Original_additional)) AND ((@IsNull_joi" +
                "ning_date = 1 AND [joining_date] IS NULL) OR ([joining_date] = @Original_joining" +
                "_date)));\r\nSELECT employee_id, name, f_name, m_name, gender, birth_date, post_co" +
                "de, thana, zela, city, phone, nid, job_post, department, salary, additional, joi" +
                "ning_date, image FROM employee WHERE (employee_id = @employee_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT employee_id, name, f_name, m_name, gender, birth_date, post_code, thana, z" +
                "ela, city, phone, nid, job_post, department, salary, additional, joining_date, i" +
                "mage FROM dbo.employee";
        ...
        public virtual int Fill(DataSet32.employeeDataTable dataTable) {
        ...
        public virtual DataSet32.employeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet32.employeeDataTable dataTable = new DataSet32.employeeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet32.employeeDataTable dataTable) {
        ...
        public virtual int Delete(string Original_employee_id, string Original_gender, string Original_birth_date, string Original_post_code, string Original_city, string Original_phone, string Original_nid, string Original_department, double Original_salary, global::System.Nullable<double> Original_additional, string Original_joining_date) {
        ...
        public virtual int Update(
            ...
            if ((Original_birth_date == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[22].Value = ((string)(Original_birth_date));
            }
            if ((Original_post_code == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[24].Value = ((string)(Original_post_code));
            }
            if ((Original_city == null)) {
            ...
            if ((Original_nid == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[30].Value = ((string)(Original_nid));
            }
            if ((Original_department == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[33].Value = ((double)(Original_salary));
            if ((Original_additional.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[34].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[35].Value = ((double)(Original_additional.Value));
            }
            else {
            ...
            if ((Original_joining_date == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[37].Value = ((string)(Original_joining_date));
            }
