...
{
    public partial class Medicine_Patient_History : Form
    {
        connection db = new connection();
        public Medicine_Patient_History()
        {
            InitializeComponent();
        ...
        private void Medicine_Patient_History_Load(object sender, EventArgs e)
        {
            header();
            ...
            // TODO: This line of code loads data into the 'DataSet56.medicine_selling_history' table. You can move, or remove it, as needed.
            this.medicine_selling_historyTableAdapter.Fill(this.DataSet56.medicine_selling_history,dd,dd2);
