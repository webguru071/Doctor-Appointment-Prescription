...
{
    public partial class doctorwise_referance : Form
    {
        connection db = new connection();
        public doctorwise_referance()
        {
            InitializeComponent();
            load_doctor();
        ...
        private void doctorwise_referance_Load(object sender, EventArgs e)
        {
            try
            {
                header();
                ...
                // TODO: This line of code loads data into the 'DataSet20.reference_list' table. You can move, or remove it, as needed.
                this.reference_listTableAdapter.Fill(this.DataSet20.reference_list, comboBox1.Text, dd, dd2);
