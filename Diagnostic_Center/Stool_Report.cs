...
{
    public partial class Stool_Report : Form
    {
        connection db = new connection();
        int id = 0;
        public Stool_Report(string x)
        {
            InitializeComponent();
        ...
        private void Stool_Report_Load(object sender, EventArgs e)
        {
            header();
            // TODO: This line of code loads data into the 'DataSet47.stool' table. You can move, or remove it, as needed.
            this.stoolTableAdapter.Fill(this.DataSet47.stool,id);
            // TODO: This line of code loads data into the 'DataSet47.diagnostic_person' table. You can move, or remove it, as needed.
            this.diagnostic_personTableAdapter.Fill(this.DataSet47.diagnostic_person,id);
