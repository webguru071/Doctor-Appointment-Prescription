...
namespace Diagnostic_Center {
    ...
    public partial class DataSet29 : global::System.Data.DataSet {
        ...
        public partial class appointmentDataTable : global::System.Data.TypedTableBase<appointmentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public appointmentRow AddappointmentRow(int reg_no, string name, string address, string age, string sex, string referance, string date, string doctor, int fees, string weight, int id) {
...
namespace Diagnostic_Center.DataSet29TableAdapters {
    ...
    public partial class appointmentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[appointment] ([reg_no], [name], [address], [age], [sex], [referance], [date], [doctor], [fees], [weight], [id]) VALUES (@reg_no, @name, @address, @age, @sex, @referance, @date, @doctor, @fees, @weight, @id);
SELECT reg_no, name, address, age, sex, referance, date, doctor, fees, weight, id FROM appointment WHERE (reg_no = @reg_no)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[appointment] SET [reg_no] = @reg_no, [name] = @name, [address] = @address, [age] = @age, [sex] = @sex, [referance] = @referance, [date] = @date, [doctor] = @doctor, [fees] = @fees, [weight] = @weight, [id] = @id WHERE (([reg_no] = @Original_reg_no) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)) AND ((@IsNull_sex = 1 AND [sex] IS NULL) OR ([sex] = @Original_sex)) AND ((@IsNull_date = 1 AND [date] IS NULL) OR ([date] = @Original_date)) AND ((@IsNull_fees = 1 AND [fees] IS NULL) OR ([fees] = @Original_fees)) AND ((@IsNull_weight = 1 AND [weight] IS NULL) OR ([weight] = @Original_weight)) AND ((@IsNull_id = 1 AND [id] IS NULL) OR ([id] = @Original_id)));
SELECT reg_no, name, address, age, sex, referance, date, doctor, fees, weight, id FROM appointment WHERE (reg_no = @reg_no)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT reg_no, name, address, age, sex, referance, date, doctor, fees, weight, id" +
                " FROM dbo.appointment where date=@x and doctor=@y";
            ...
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@y", global::System.Data.SqlDbType.NVarChar, 2147483647, global::System.Data.ParameterDirection.Input, 0, 0, "doctor", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(DataSet29.appointmentDataTable dataTable, string x, string y) {
        ...
        public virtual DataSet29.appointmentDataTable GetData(string x, string y) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((x == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            ...
            DataSet29.appointmentDataTable dataTable = new DataSet29.appointmentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet29.appointmentDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet29 dataSet) {
        ...
        public virtual int Delete(int Original_reg_no, string Original_age, string Original_sex, string Original_date, global::System.Nullable<int> Original_fees, string Original_weight, global::System.Nullable<int> Original_id) {
        ...
        public virtual int Insert(int reg_no, string name, string address, string age, string sex, string referance, string date, string doctor, global::System.Nullable<int> fees, string weight, global::System.Nullable<int> id) {
        ...
        public virtual int Update(
            ...
            if ((Original_fees.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[19].Value = ((int)(Original_fees.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string Original_weight, 
                    global::System.Nullable<int> Original_id) {
            return this.Update(Original_reg_no, name, address, age, sex, referance, date, doctor, fees, weight, id, Original_reg_no, Original_age, Original_sex, Original_date, Original_fees, Original_weight, Original_id);
        }
    }
