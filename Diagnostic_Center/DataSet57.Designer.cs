...
namespace Diagnostic_Center {
    ...
    public partial class DataSet57 : global::System.Data.DataSet {
        ...
        public partial class appointmentDataTable : global::System.Data.TypedTableBase<appointmentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public appointmentRow AddappointmentRow(int reg_no, string name, string address, string age, string sex, string referance, string date, string doctor, int fees, string weight, int id, string card_id, string card_type, string date2, string hospital_id) {
...
namespace Diagnostic_Center.DataSet57TableAdapters {
    ...
    public partial class appointmentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[appointment] ([reg_no], [name], [address], [age], [sex], [referance], [date], [doctor], [fees], [weight], [id], [card_id], [card_type], [date2], [hospital_id]) VALUES (@reg_no, @name, @address, @age, @sex, @referance, @date, @doctor, @fees, @weight, @id, @card_id, @card_type, @date2, @hospital_id);
SELECT reg_no, name, address, age, sex, referance, date, doctor, fees, weight, id, card_id, card_type, date2, hospital_id FROM appointment WHERE (reg_no = @reg_no)";
...
SELECT reg_no, name, address, age, sex, referance, date, doctor, fees, weight, id, card_id, card_type, date2, hospital_id FROM appointment WHERE (reg_no = @reg_no)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT reg_no, name, address, age, sex, referance, date, doctor, fees, weight, id" +
                ", card_id, card_type, date2, hospital_id FROM dbo.appointment where date between" +
                " @x and @y";
        ...
        public virtual int Fill(DataSet57.appointmentDataTable dataTable, string x, string y) {
        ...
        public virtual DataSet57.appointmentDataTable GetData(string x, string y) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((x == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            ...
            DataSet57.appointmentDataTable dataTable = new DataSet57.appointmentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet57.appointmentDataTable dataTable) {
        ...
        public virtual int Insert(int reg_no, string name, string address, string age, string sex, string referance, string date, string doctor, global::System.Nullable<int> fees, string weight, global::System.Nullable<int> id, string card_id, string card_type, string date2, string hospital_id) {
        ...
        public virtual int Update(
            ...
            if ((Original_fees.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[23].Value = ((int)(Original_fees.Value));
            }
            else {
            ...
            if ((Original_id.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[27].Value = ((int)(Original_id.Value));
            }
            else {
            ...
            if ((Original_card_id == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[29].Value = ((string)(Original_card_id));
            }
            if ((Original_card_type == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[31].Value = ((string)(Original_card_type));
            }
            if ((Original_date2 == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[33].Value = ((string)(Original_date2));
            }
            if ((Original_hospital_id == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[35].Value = ((string)(Original_hospital_id));
            }
        ...
        public virtual int Update(
                    ...
                    string Original_date2, 
                    string Original_hospital_id) {
            return this.Update(Original_reg_no, name, address, age, sex, referance, date, doctor, fees, weight, id, card_id, card_type, date2, hospital_id, Original_reg_no, Original_age, Original_sex, Original_date, Original_fees, Original_weight, Original_id, Original_card_id, Original_card_type, Original_date2, Original_hospital_id);
        }
    }
