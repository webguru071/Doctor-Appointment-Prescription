...
{
    partial class daily_patient_account
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.DataSet6 = new Diagnostic_Center.DataSet6();
            this.user_cash_collection_hospitalBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.user_cash_collection_hospitalTableAdapter = new Diagnostic_Center.DataSet6TableAdapters.user_cash_collection_hospitalTableAdapter();
            this.hospital_due_collectionBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.hospital_due_collectionTableAdapter = new Diagnostic_Center.DataSet6TableAdapters.hospital_due_collectionTableAdapter();
            ...
            reportDataSource2.Name = "DataSet6a";
            reportDataSource2.Value = this.hospital_due_collectionBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource2);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Diagnostic_Center.Report6.rdlc";
            this.reportViewer1.Location = new System.Drawing.Point(8, 30);
            this.reportViewer1.Name = "reportViewer1";
            this.reportViewer1.Size = new System.Drawing.Size(666, 480);
            ...
            this.user_cash_collection_hospitalBindingSource.DataSource = this.DataSet6;
            // 
            ...
            this.Name = "daily_patient_account";
            this.Text = "daily_patient_account";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.Load += new System.EventHandler(this.daily_patient_account_Load);
        ...
        private DataSet6TableAdapters.user_cash_collection_hospitalTableAdapter user_cash_collection_hospitalTableAdapter;
        private DataSet6TableAdapters.hospital_due_collectionTableAdapter hospital_due_collectionTableAdapter;
    }
}