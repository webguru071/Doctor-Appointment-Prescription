...
{
    public partial class User_Single_Collection_Print : Form
    {
        connection db = new connection();
        int a = 0;
        int reg = 0;
        public User_Single_Collection_Print(string x,string r)
        {
            InitializeComponent();
            a = Convert.ToInt32(x);
            reg = Convert.ToInt32(r);
            this.reportViewer1.SetDisplayMode(DisplayMode.PrintLayout);
            reportViewer1.ZoomMode = ZoomMode.Percent;
            reportViewer1.ZoomPercent = 100;
        }

        private void User_Single_Collection_Print_Load(object sender, EventArgs e)
        {
            header();
            ...
            this.user_cash_collection_hospitalTableAdapter.Fill(this.DataSet40.user_cash_collection_hospital,a);
