...
{
    public partial class Print_Diagnostic_Due_List : Form
    {
        connection db = new connection();
        public Print_Diagnostic_Due_List()
        {
            InitializeComponent();
        ...
        private void Print_Diagnostic_Due_List_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'DataSet65.paid_and_due' table. You can move, or remove it, as needed.
            header();
            ...
            this.paid_and_dueTableAdapter.Fill(this.DataSet65.paid_and_due,dd,dd2);
