...
{
    public partial class only_lab_copy : Form
    {
        int reg;
        connection db = new connection();
        public only_lab_copy(int x)
        {
            InitializeComponent();
        ...
        private void only_lab_copy_Load(object sender, EventArgs e)
        {
            header();
            // TODO: This line of code loads data into the 'DataSet1.user_cash_collection' table. You can move, or remove it, as needed.
            this.user_cash_collectionTableAdapter.Fill(this.DataSet1.user_cash_collection,reg.ToString());
