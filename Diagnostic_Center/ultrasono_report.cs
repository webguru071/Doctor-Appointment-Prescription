...
{
    public partial class ultrasono_report : Form
    {
        connection db = new connection();
        string reg = "";
        int id = 0;
        public ultrasono_report(string x)
        {
            InitializeComponent();
            reg = x;
        ...
        private void ultrasono_report_Load(object sender, EventArgs e)
        {
            try
            {
                header();
                // TODO: This line of code loads data into the 'DataSet25.diagnostic_person' table. You can move, or remove it, as needed.
                this.diagnostic_personTableAdapter.Fill(this.DataSet25.diagnostic_person, id);
                // TODO: This line of code loads data into the 'DataSet25.ultrasono' table. You can move, or remove it, as needed.
                this.ultrasonoTableAdapter.Fill(this.DataSet25.ultrasono, reg);
