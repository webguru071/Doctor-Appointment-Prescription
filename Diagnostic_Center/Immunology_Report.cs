...
{
    public partial class Immunology_Report : Form
    {
        connection db = new connection();
        int id = 0;
        public Immunology_Report(string x)
        {
            InitializeComponent();
        ...
        private void Immunology_Report_Load(object sender, EventArgs e)
        {
            header();
            // TODO: This line of code loads data into the 'DataSet46.immunology' table. You can move, or remove it, as needed.
            this.immunologyTableAdapter.Fill(this.DataSet46.immunology,id);
            // TODO: This line of code loads data into the 'DataSet46.diagnostic_person' table. You can move, or remove it, as needed.
            this.diagnostic_personTableAdapter.Fill(this.DataSet46.diagnostic_person,id);
