...
{
    public partial class Medicine_Cells_History : Form
    {
        connection db = new connection();
        public Medicine_Cells_History()
        {
            InitializeComponent();
        ...
        private void Medicine_Cells_History_Load(object sender, EventArgs e)
        {
            header();
            ...
            // TODO: This line of code loads data into the 'DataSet41.medicine_sells' table. You can move, or remove it, as needed.
            this.medicine_sellsTableAdapter.Fill(this.DataSet41.medicine_sells,dd,dd2);
